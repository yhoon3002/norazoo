...
export function MapBaker() {
    ...
    useFrame(() => {
        ...
        // 3) 렌더타겟·이전 타겟·숨김 목록은 finally에서 반드시 정리해야 하므로 try 밖에서 선언
        ...
        try {
            ...
            for (const child of scene.children) {
                ...
                child.traverse((o: unknown) => {
                    ...
                    if ((obj as THREE.Mesh).isMesh) {
                        hasMesh = true;
                        if (obj.userData.__type === "environment")
                            hasEnv = true;
                    }
                });
            ...
            // 예외 발생 여부와 무관하게 렌더타겟 바인딩·리소스·가시성을 항상 복구
